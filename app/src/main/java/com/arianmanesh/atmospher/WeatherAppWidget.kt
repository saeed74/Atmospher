...
internal fun updateAppWidget(
    ...
    val city = "IRAN | TEST"
    val temp = "20°C"
    views.setTextViewText(R.id.txtCityName, city)
    views.setTextViewText(R.id.txtCityTemperature, temp)

    val appWidgetTarget = AppWidgetTarget(context,R.id.imgWeatherIcon,views,appWidgetId)

    Glide.with(context.applicationContext)
        .asBitmap()
        .load("https://cdn.weatherapi.com/weather/64x64/night/302.png")
